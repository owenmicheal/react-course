...
import { Nav, Hero, HomeCards } from './components';
...
const App = () => {
  ...
  {/* Components */}
    ...
    {/* <!-- Hero Section--> */}
    {/* props */}
    <Hero /> {/*we can pass props to the Hero component eg title: 'React Jobs', subtitle: 'Find your dream job as a React developer'*/}
